...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, BACKGROUND, col_cyan  },
};
...
static const char *tagsel[][2] = {
       { FULL_BLACK, RAINBOW_RED },
       { FULL_BLACK, RAINBOW_ORANGE },
       { FULL_BLACK, RAINBOW_YELLOW },
       { FULL_BLACK, RAINBOW_GREEN },
       { FULL_BLACK, RAINBOW_BLUE },
       { FULL_BLACK, RAINBOW_INDIGO },
       { FULL_BLACK, RAINBOW_VIOLET },
};
